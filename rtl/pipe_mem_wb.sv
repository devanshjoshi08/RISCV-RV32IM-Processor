module pipe_mem_wb (
  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      pc_plus4_out <= 0; alu_result_out <= 0;
      mem_read_data_out <= 0; rd_addr_out <= 0;
